...
Система контролю версій вона дозволяє зберігати декілька створених версій файлу, проекту чи його складових, а також бачити зміни, які були створені розробником по роботі.
...
Замережити вітки з віддаленого репозиторію: `git pull origin`
Замережити вітку master з віддаленого репозиторію: `git pull origin master`
Замережити усе з вітки origin без мерджу в локальний репозиторій: `git fetch origin`
...
Подивіться, наприклад, на мій профіль Github: [github.com/dzudzylo](https://github.com/dzudzylo).
...
> Продуманий, легкий, надійний сервіс, GitHub не в останню чергу - один з двигунів open-source. "Викласти на GitHub" - напевно, перше, що спадає на думку, > якщо код переростає із чогось непотрібного в щось, що може використовувати не тільки його автор.
> GitHub - це і хостинг для вашого коду, і вікі, і діффи, та відстеження історії змін, і, крім іншого, прекрасний інструмент для самонавчання, причому > двостороннього. По-перше, завжди можна подивитися, як інші розробники підходять до наявної проблеми, або дізнатися, як влаштований інструмент, яким ви > користуєтеся. По-друге, з пулл-реквестов до викладеного вами можна почерпнути багато корисного.
> Взагалі, коли є сервіс, який бере на себе одну з задач, яка стоїть перед початківцям: хостинг коду і спільну роботу над ним, а у випадку з GitHub ще й > вирішує її так успішно, то що ще треба?